...
<div class="main">
    <div class="checkBox">
        <input class="checkbox-round" type="checkbox" value={Number(todo.completed)} on:change={() => {todo.completed = !todo.completed}}>
    </div>
<p on:dblclick={() => {todo.completed = !todo.completed}}  class={todo.completed?"todoText completed":"todoText"}>{todo.task}</p>
</div>
<div class="delete">
